...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl border border-border/60 bg-card p-1 text-muted-foreground shadow-[var(--shadow-sm)]",
      className,
    )}
    {...props}
  />
